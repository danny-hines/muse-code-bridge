...
const result = await build({
  entryPoints: { 'muse-server': 'src/server.mjs', 'configure-host': 'scripts/configure-host.mjs', 'configure-auth': 'scripts/configure-auth.mjs', 'configure-skills': 'scripts/configure-skills.mjs' },
